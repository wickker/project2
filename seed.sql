...
insert into profiles (member_type_id, member_id, picture, dateofbirth, gender, club_website_url, club_ig_url, club_facebook_url) values (1, 2, 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Emoji_u263a.svg/768px-Emoji_u263a.svg.png', '1977-06-11', 'Female', '', '', '');
insert into profiles (member_type_id, member_id, picture, dateofbirth, gender, club_website_url, club_ig_url, club_facebook_url) values (1, 3, 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Emoji_u263a.svg/768px-Emoji_u263a.svg.png', '2006-04-24', 'Female', '', '', '');
insert into profiles (member_type_id, member_id, picture, dateofbirth, gender, club_website_url, club_ig_url, club_facebook_url) values (1, 4, 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Emoji_u263a.svg/768px-Emoji_u263a.svg.png', '2010-02-15', 'Male', '', '', '');
insert into profiles (member_type_id, member_id, picture, dateofbirth, gender, club_website_url, club_ig_url, club_facebook_url) values (1, 5, 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Emoji_u263a.svg/768px-Emoji_u263a.svg.png', '1959-02-19', 'Male', '', '', '');
