      ...
      <div className="container">
        <div className="row">
          <div className="col mt-4">
            <div className="h3 mt-4 mb-5">Summary</div>
            <div id="table-div">
              <table class="table table-bordered table-dark">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {parseInt(clubsCount.acro) + parseInt(athCount.acro)}
                    </td>
                    <td>
                      {parseInt(clubsCount.aero) + parseInt(athCount.aero)}
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="form">
              <div className="mb-4 mt-2 h4">View Details</div>
              <DiscDropdown />
            </div>
          </div>
        </div>
